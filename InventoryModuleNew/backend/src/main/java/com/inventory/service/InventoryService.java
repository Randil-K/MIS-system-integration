...
public class InventoryService {
    ...
    public Map<String, Object> addStock(Long productId, Integer quantity, String referenceDoc) {
        ...
        Inventory inventory = inventoryRepository.findByProductId(productId)
                .orElseThrow(() -> new ResourceNotFoundException("Product not found in inventory with ID: " + productId));
    ...
    public Map<String, Object> reduceStock(Long productId, Integer quantity, String referenceDoc) {
        ...
        if (previousQuantity < quantity) {
            throw new InsufficientStockException("Insufficient stock. Available: " + previousQuantity + ", Required: " + quantity);
        }
